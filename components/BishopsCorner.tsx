      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="relative w-full lg:w-1/2 group">
            ...
            <div className="absolute -top-4 -left-4 w-full h-full border-4 border-gold/20 rounded-2xl transition-transform duration-500 group-hover:-translate-x-1 group-hover:-translate-y-1" />
            
            <img 
              src="https://i.imgur.com/22kbweA.jpg" 
              alt="Bishop Njobvu"
              className="relative z-10 rounded-2xl shadow-2xl w-full h-[650px] object-cover object-top grayscale-[20%] group-hover:grayscale-0 transition-all duration-700 ease-in-out"
              loading="lazy"
              onError={(e) => {
            ...
            {/* Floating Quote Box */}
            <div className="absolute -bottom-6 -right-6 bg-gold p-8 rounded-2xl z-20 shadow-2xl hidden sm:block">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
              <p className="italic border-l-4 border-gold pl-6 py-2">
              ...
              <p className="font-header italic text-3xl text-navy pt-4">You were born to overcome.</p>
              
              <div className="pt-8">
                <div className="w-12 h-1 bg-gold mb-2"></div>
                <p className="text-gold font-bold text-sm uppercase tracking-widest">— Bishop Njobvu, Lead Pastor</p>
              </div>
            </div>
          </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="relative w-full lg:w-1/2">
            ...
            <div className="absolute -top-4 -left-4 w-full h-full border-4 border-amber-400/20 rounded-2xl" />
            ...
            <img 
              ...
              onError={(e) => {
                ...
                target.src = "https://images.unsplash.com/photo-1544427928-14299446d7e9?auto=format&fit=crop&q=80&w=800"; // Fallback if Imgur fails
              }}
            />
